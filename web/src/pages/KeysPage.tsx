...
// The age comes from the response, not from this browser. The dashboard counts
// aged keys with the database's clock, and working it out here from Date.now()
// let the two disagree about the same key — which is the thing the shared
// threshold above exists to prevent, solved for the number and not for the age.
function KeyAge({ days, advisoryDays }: { days: number; advisoryDays: number }) {
...
export function KeysPage() {
  ...
  const agingKey = activeKey ? activeKey.age_days > advisoryDays : false
